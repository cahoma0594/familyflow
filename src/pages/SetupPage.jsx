...
const s = {
  ...
  card: { background:'white', borderRadius:16, padding:'40px 36px', width:'100%', maxWidth:420,
  ...
  input: { width:'100%', padding:'12px 14px', border:'1.5px solid #E5E7EB', borderRadius:12,
    fontSize:14, outline:'none', background:'#F9FAFB', marginBottom:10 },
  hint: { fontSize:12, color:'#aaa', marginBottom:16 },
  err: { background:'#FEF2F0', color:'#E07A5F', fontSize:13, padding:'10px 14px',
    borderRadius:10, marginBottom:12 },
  btn: { width:'100%', padding:'13px', background:'#111827', color:'white', border:'none',
